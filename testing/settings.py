...
SECRET_KEY = 'django-insecure-=d(j0y-=n#upoqmtxx+(&$tn)y)v^mf@&!8(@2%cj7scrhy8^%'
...
#         'NAME': 'crm',          # Replace with your database name
#         'USER': 'root',      # Replace with your database username
#         'PASSWORD': 'root',      # Replace with your database password
#         'HOST': 'localhost',           # Replace with your database host (leave empty for localhost)
#         'PORT': '',                    # Replace with your database port (leave empty for default)
#     }
# }
